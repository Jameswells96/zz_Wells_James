...
ggplot(data = ToothData) + #This str function helps us visualize the data in a compact form
  geom_bar(mapping = aes(x=dose, y=len, fill=supp), position = "dodge",
           stat = 'identity') + ggtitle("The Effect of Vitamin C on Tooth Growth in Guinea Pigs") + xlab("Supplement dosage (mg/day)") + ylab("Odontoblast Length") #The ToothData is applied to a bar graph to display the two variables tooth length and supplement dosage. The "fill" variable 
```
#
